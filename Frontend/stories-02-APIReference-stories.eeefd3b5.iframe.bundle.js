"use strict";(self.webpackChunkdim=self.webpackChunkdim||[]).push([[137],{"./src/stories/02-APIReference.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{UseDimStore:()=>UseDimStore,UseEffect:()=>UseEffect,UseMemo:()=>UseMemo,UseRef:()=>UseRef,UseScope:()=>UseScope,UseState:()=>UseState,UseStore:()=>UseStore,UseStyle:()=>UseStyle,UseViewTransition:()=>UseViewTransition,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_core_dim_ts__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/core/dim.ts"),_hooks_useDimStore_ts__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./src/hooks/useDimStore.ts");const UseDimStoreReactDemo=()=>{const[note,setNote,isLoading]=(0,_hooks_useDimStore_ts__WEBPACK_IMPORTED_MODULE_2__.H)({key:"api-ref-demo-note",password:"api-ref-demo-key",defaultValue:""});return isLoading?react__WEBPACK_IMPORTED_MODULE_0__.createElement("p",null,"Loading encrypted store…"):react__WEBPACK_IMPORTED_MODULE_0__.createElement("div",{style:{padding:"2rem",border:"2px solid #029cfd",borderRadius:"8px",minWidth:"280px"}},react__WEBPACK_IMPORTED_MODULE_0__.createElement("p",null,"React useDimStore (encrypted IndexedDB)"),react__WEBPACK_IMPORTED_MODULE_0__.createElement("input",{value:note,onChange:e=>setNote(e.target.value),placeholder:"Persisted note…",style:{width:"100%",padding:"0.5rem",marginBottom:"0.5rem"}}),react__WEBPACK_IMPORTED_MODULE_0__.createElement("small",null,"Shares DimDatabase with useStore when keys and encryption keys match."))};(0,_core_dim_ts__WEBPACK_IMPORTED_MODULE_1__.E8)({tag:"usestate-demo",component:(props,{useState,html,css,useStyle})=>{const[count,setCount]=useState(0),[text,setText]=useState(""),[items,setItems]=useState(["Item 1","Item 2"]);useStyle(css`
    .state-demo {
      display: flex;
  ...
  `}}),(0,_core_dim_ts__WEBPACK_IMPORTED_MODULE_1__.E8)({tag:"useviewtransition-demo",component:(props,{useState,useStyle,useViewTransition,html,css})=>{const[page,setPage]=useState(0),transition=useViewTransition(page.toString(),{duration:400});useStyle(css`
    ${_core_dim_ts__WEBPACK_IMPORTED_MODULE_1__.fZ}
    .vt-demo {
      padding: 2rem;
      border: 2px solid #029cfd;
      border-radius: 8px;
  ...
  `);const titles=["Home","About","Contact"];return html`
    <div class="vt-demo">
      <div class="vt-nav">
        ${titles.map(((_,i)=>html`
            <button
